...

{
    ...
    assert.strictEqual(versionJson.version, '20260822.13', 'version.json must be 20260822.13');
    assert.match(htmlContent, /const CURRENT_VERSION = "20260822\.13";/, 'CURRENT_VERSION in index.html must be 20260822.13');
    assert.match(htmlContent, /id="drawer-version-text">KPI Suite v20260822\.13<\/span>/, 'Drawer footer must display 20260822.13');
