...
console.log('=== RUNNING KPITRACKER NEGATIVE AUTH & RUNTIME REMEDIATION TESTS (v20260823.07) ===\n');
...

{
    ...
    assert.strictEqual(versionJson.version, '20260823.07', 'version.json must be 20260823.07');
    assert.match(htmlContent, /const CURRENT_VERSION = "20260823\.07";/, 'CURRENT_VERSION in index.html must be 20260823.07');
    assert.match(htmlContent, /id="drawer-version-text">KPI Suite v20260823\.07<\/span>/, 'Drawer footer must display 20260823.07');
