...

{
    ...
    assert.strictEqual(versionJson.version, '20260825.05', 'version.json must be 20260825.05');
    assert.match(htmlContent, /const CURRENT_VERSION = "20260825\.05";/, 'CURRENT_VERSION in index.html must be 20260825.05');
    assert.match(htmlContent, /id="drawer-version-text">KPI Suite v20260825\.05<\/span>/, 'Drawer footer must display 20260825.05');
    assert.match(htmlContent, /supabase-kpi-client\.js\?v=20260825\.05/, 'Incident client asset cache key must match 20260825.05');
