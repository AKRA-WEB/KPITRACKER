...
console.log('=== RUNNING KPITRACKER NEGATIVE AUTH & RUNTIME REMEDIATION TESTS (v20260824.02) ===\n');
...

{
    ...
    assert.strictEqual(versionJson.version, '20260824.02', 'version.json must be 20260824.02');
    assert.match(htmlContent, /const CURRENT_VERSION = "20260824\.02";/, 'CURRENT_VERSION in index.html must be 20260824.02');
    assert.match(htmlContent, /id="drawer-version-text">KPI Suite v20260824\.02<\/span>/, 'Drawer footer must display 20260824.02');
