...

{
    ...
    assert.match(htmlContent, /const CURRENT_VERSION = "20260825\.02";/, 'CURRENT_VERSION in index.html must be 20260825.02');
    assert.match(htmlContent, /id="drawer-version-text">KPI Suite v20260825\.02<\/span>/, 'Drawer footer must display 20260825.02');
    assert.match(htmlContent, /supabase-kpi-client\.js\?v=20260825\.02/, 'Incident client asset cache key must match 20260825.02');
