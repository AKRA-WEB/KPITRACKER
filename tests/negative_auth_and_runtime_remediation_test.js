...
console.log('=== RUNNING KPITRACKER NEGATIVE AUTH & RUNTIME REMEDIATION TESTS (v20260824.01) ===\n');
...

{
    ...
    assert.strictEqual(versionJson.version, '20260824.01', 'version.json must be 20260824.01');
    assert.match(htmlContent, /const CURRENT_VERSION = "20260824\.01";/, 'CURRENT_VERSION in index.html must be 20260824.01');
    assert.match(htmlContent, /id="drawer-version-text">KPI Suite v20260824\.01<\/span>/, 'Drawer footer must display 20260824.01');
