...
assert.ok(htmlContent.includes('const CURRENT_VERSION = "20260825.04";'), 'index.html must have CURRENT_VERSION 20260825.04');
assert.ok(htmlContent.includes('KPI Suite v20260825.04'), 'index.html drawer must show KPI Suite v20260825.04');
assert.ok(htmlContent.includes('supabase-kpi-client.js?v=20260825.04'), 'index.html script tag must have v=20260825.04');
